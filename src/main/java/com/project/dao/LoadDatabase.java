...
public class LoadDatabase {
	...
	CommandLineRunner initDatabase(AccountDao accountDao, CatalogDao catalogDao, SequenceDao sequenceDao, AddressDao addressDao) {
		...
		return args -> {
			...
			log.info("Preloading " + addressDao.save(new Address((long) addressDao.count()+1, "Canada", Long.parseLong("4161234567"), "4700 keele street", null, "North York", "ON", "M3J1P3", true)));
