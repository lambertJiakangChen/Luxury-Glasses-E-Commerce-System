...
const Navbar = (props) => {
  ...
  return (
    <div className={`navbar-navbar ${props.rootClassName} `}>
        ...
        <div className="navbar-navbar1">
          ...
          <div className="navbar-middle">
            <div className="navbar-left">
              <Link to="/products" className="navbar-text navbar-link">
                {props.text}
              </Link>
              <span className="navbar-link">{props.text1}</span>
              <a href="#recommendations" className="navbar-text02 navbar-link">
                {props.text2}
              </a>
            </div>
            ...
            <div className="navbar-right">
              <a href="#aboutus" className="navbar-text03 navbar-link">
                {props.text3}
              </a>
              <span className="navbar-link">{props.text4}</span>
              <a href="#chatbot" className="navbar-text05 navbar-link">
                {props.text5}
              </a>
            </div>
          </div>
          <div className="navbar-icons">
            <Link to="/view-cart" className="navbar-navlink">
              <img
        ...
        <div data-role="MobileMenu" className="navbar-mobile-menu">
          <div className="navbar-nav">
            <div className="navbar-container1">
              <span className="navbar-logo-center1">{props.Logo_center1}</span>
              <div
            ...
            <div className="navbar-middle1">
              ...
              <span className="navbar-text10">{props.text10}</span>
              <span className="navbar-text11">{props.text11}</span>
            </div>
          </div>
          <div className="">
      ...
      {
        showMenu? <DropDown
        rootClassName="drop-down-root-class-name"
        className=""
      ></DropDown> : null
      }  
    </div>
...
Navbar.defaultProps = {
  ...
  image_alt3: 'AccountCircle3271301',
  text: 'SHOP',
  image_src3:
  ...
  text7: 'LOOKBOOK',
  Logo_center: 'LUX LENS',
  text1: 'LOOKBOOK',
  image_alt: 'search3271286',
  text10: 'BLOG',
  image_src:
  ...
  text3: 'ABOUT',
  search_input: 'Search',
  image_alt1: 'iconsbxscart3271299',
  text11: 'CONTACT',
  rootClassName: '',
  text9: 'ABOUT',
  Logo_center1: 'MOBILLIO',
}
